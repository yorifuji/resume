...
- 自社開発のWeb会議サービスの設計・開発、運用業務など
- 通信キャリアのR&D受託案件のマネジメント業務
- AWSを使ったクラウドサービスの設計や開発
- プロジェクトマネジメント、エンジニアチームのマネジメント
- 新規事業のPoC
...
- アジャイル開発でスモール開発をして仮説検証を行うプロセスに興味があります
- モバイルアプリが好きですがバックエンドやフロントエンドにも興味があります
  - iOS / SwiftUI / Combine
  - React / Vue など
  - AWS / GCP などのクラウドサービス、Firebase などの mBaaS
  - WebRTC
